                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <div style="font-family:Montserrat, monospace;font-size:18px;line-height:160%;color:#000000;text-align:left;">Hi {{ $user->name }},</div>
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <div style="font-family:Montserrat, monospace;font-size:18px;line-height:160%;text-align:justify;color:#000000;">We are sorry to say that <b>{{$copilot->name}}</b> is unavailable or has declined <b><?php echo trim($advisorRequest->request_title)?></b>. Lucky for you, there are other CoPilots that are ready for takeoff. Click below to determine how you would like to proceed.</div>
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <div style="font-family:Montserrat, monospace;font-size:18px;line-height:160%;text-align:justify;color:#000000;">Please note you must select the next steps before the task can be fully activated.</div>
                            ...
                            <tr>
                                <td align="center" vertical-align="middle" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <a href="{{ uiAppUrl(  ) }}advisor-reassignment/{{ urlencode( base64_encode( $advisorRequest->id ) ) }}" style="text-decoration: none; cursor: pointer">
