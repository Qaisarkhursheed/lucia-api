                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <div style="font-family:Cormorant, Arial;font-size:34px;font-weight:100;letter-spacing:0;line-height:38px;text-align:center;color:#000000;">Request Accepted by {{ $advisorRequest->advisor_assigned_copilot->user->first_name }}</div>
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <div style="font-family:Montserrat, Arial;font-size:14px;line-height:160%;text-align:center;color:#000000;">
                                        Hey {{ $advisorRequest->user->first_name }},</div>
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <div style="font-family:Montserrat, Arial;font-size:14px;line-height:160%;text-align:center;color:#000000;">
                                        Your request, regarding {{ $advisorRequest->request_title }}, has been accepted by {{ $advisorRequest->advisor_assigned_copilot->user->first_name }}.
                                    </div>
                            ...
                            <tr>
                                <td align="center" vertical-align="middle" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <a href="{{ uiAppUrl(  ) }}" style="text-decoration: none; cursor: pointer">
