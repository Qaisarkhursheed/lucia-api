                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <div style="font-family:Cormorant, Arial;font-size:34px;font-weight:100;letter-spacing:0;line-height:38px;text-align:center;color:#000000;">PDF Import Error</div>
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <div style="font-family:Montserrat, Arial;font-size:14px;line-height:160%;text-align:center;color:#000000;">Hi {{ $bookingOcr->user->first_name }},
                                        We are sorry to inform you that the file ( <a href="{{ $bookingOcr->document_url }}"> {{ $bookingOcr->file_name }} </a> ) you uploaded for your itinerary ( {{ optional($bookingOcr->itinerary)->title }} )
                                        was  <mj-text style="color:#EB6C6C;">NOT PROCESSABLE</mj-text> by our OCR engine at the moment.</div>
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <div style="font-family:Montserrat, Arial;font-size:14px;line-height:160%;text-align:center;color:#000000;">Our technical team has been informed about the incident.</div>
