<mjml>
  ...
  <mj-column>
    ...
    <mj-section background-color="#fff">
      <mj-column>
        <mj-text mj-class="heading">Confirm your account</mj-text>
        <mj-text>Hey {{ $user->name }}, Please confirm your account with this code:</mj-text>
        <mj-text font-size="44px" color="#BA886E" align="center" font-family="Cormorant, monospace">{{ $code }}</mj-text>
