<mjml>
  ...
  <mj-column>
    ...
    <mj-section background-color="#fff">
      <mj-column>
        <mj-text mj-class="heading">Password Successfully Changed</mj-text>
        <mj-text>Hi {{ $user->name }},</mj-text>
        <mj-text>Your account password has been changed successfully. If you did this then you have no further action to take. If you did not action this and there has been a breach please contact <a class="link-nostyle" href="mailto:hello@letslucia.com"><strong>hello@letslucia.com</strong></a>.</mj-text>
