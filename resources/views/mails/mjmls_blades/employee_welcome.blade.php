  ...
  <mj-column>
    ...
    <mj-section background-color="#fff">
      <mj-column>
        ...
        <mj-text padding-bottom="30px"> You&rsquo;re invited to join In the Know Experiences on Lucia&mdash;the travel platform, designed for outsourcing, editorial storytelling, and inspiring luxury travelers. </mj-text>
        ...
        <mj-text padding-top="30px">Click the button below to get started. If you have trouble accessing your account or run into any other issues, simply respond to this email. We&rsquo;re here to help.</mj-text>
        <mj-button width="100%"  href="{{ uiAppUrl( 'signin' ) }}">Get started</mj-button>
