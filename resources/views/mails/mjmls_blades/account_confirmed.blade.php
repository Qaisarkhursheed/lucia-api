<?php /** @var \App\ModelsExtended\User $user **/ ?>
...
<mjml>
  <mj-head>
    ...
    <mj-attributes>
      <mj-class name="heading" align="center" line-height="38px" font-size="34px" letter-spacing="0" font-weight="100" font-family="Cormorant, Arial" />
      <mj-button background-color="#BA886E" font-size="14px" align="center" letter-spacing="2" font-weight="700" font-family="Montserrat, Arial" inner-padding="20px 20px" />
  ...
  <mj-column>
    ...
    <mj-section background-color="#fff">
      <mj-column>
        <mj-text mj-class="heading">Your account has been approved as {{ $user->lastestUserRole()->role->description }}.</mj-text>
        <mj-text>Hi {{ $user->name }},</mj-text>

          @if( $password !== \App\Mail\Auth\AccountApprovedMail::SKIP__PASSWORD__SECTION )
          <mj-text align="center
                        " font-size="14px">Your temporary password is:</mj-text>
          <mj-text font-size="44px" color="#BA886E" align="center" font-family="Cormorant, monospace">{{ $password }}</mj-text>
          @endif

          <mj-button width="100%" href="{{ uiAppUrl( 'signin' ) }}">LOGIN</mj-button>

          <mj-text>Welcome to Lucia. We know you’re going to love it. </mj-text>
          <mj-text>If you have any issues or questions please contact support <a class="link-nostyle" href="mailto:hello@letslucia.com"><strong>hello@letslucia.com</strong></a>. </mj-text>
