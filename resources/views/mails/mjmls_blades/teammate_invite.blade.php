...
<mjml>
  ...
  <mj-column>
    ...
    <mj-section background-color="#fff">
      <mj-column>
        <mj-text mj-class="heading">Hi {{ $user->name }},</mj-text>
        <mj-text>You&rsquo;re invited by <strong>{{ $user->master_sub_account->master_account->title  }}</strong> to join In the Know Experiences on Lucia&mdash;the travel platform, designed for outsourcing, editorial storytelling, and inspiring luxury travelers.</mj-text>
          <mj-text> Click the button below to confirm this relationship and get started. </mj-text>
        ...
        <mj-button width="100%" href="{{ uiAppUrl( 'signin' ) }}">CONNECT WITH LUCIA</mj-button>
        <mj-text>If you have trouble accessing your account or run into any other issues, simply respond to this email. We&rsquo;re here to help.</mj-text>
        <mj-text>Welcome to Lucia. We know you&rsquo;re going to love it,</mj-text>
