<mjml>
  ...
  <mj-column>
    ...
    <mj-section background-color="#fff">
      <mj-column>
        <mj-image src="https://randomuser.me/api/portraits/men/0.jpg" align="center" width="70px" height="70px" border-radius="50%"></mj-image>
        <mj-text mj-class="heading" align="center">Hi [Name], Henry invited you to join Lucia </mj-text>
        <mj-text align="center">You have been invited to join <a class="link-nostyle" href="https://www.letslucia.com"><strong>Letslucia.com</strong></a>&mdash;the travel platform, designed for outsourcing, editorial storytelling, and inspiring luxury travelers.</mj-text>
        <mj-text align="center">Click the button below to get started. If you have trouble accessing your account or run into any other issues, simply respond to this email. We&rsquo;re here to help.</mj-text>
        <mj-divider border-width="2px" border-color="white" />
        <mj-button width=100%>ACCEPT INVITATION</mj-button>
