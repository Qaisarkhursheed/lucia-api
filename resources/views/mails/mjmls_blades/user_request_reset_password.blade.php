<mjml>
  <mj-head>
    ...
    <mj-attributes>
      <mj-class name="heading" align="center" font-size="34px" letter-spacing="0" font-weight="100" font-family="Cormorant, Arial" />
  ...
  <mj-column>
    ...
    <mj-section background-color="#fff">
      <mj-column>
        <mj-text mj-class="heading">Account update</mj-text>
        <mj-text> To reset your password, click the button below. If you did not contact us to change your password, you can ignore this message. </mj-text>
        <mj-button width="100%" href="{{ url }}">RESET PASSWORD</mj-button>
