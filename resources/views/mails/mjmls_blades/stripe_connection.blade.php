<mjml>
  ...
  <mj-column>
    ...
    <mj-section background-color="#fff">
      <mj-column>
        <mj-text mj-class="heading">Successful account connection</mj-text>
        <mj-text>Hi {{ $user->name }},</mj-text>
        <mj-text>You've successfully connected Stripe to your Lucia account. Wasn't you? Please contact <a class="link-nostyle" href="mailto:hello@letslucia.com"><strong>hello@letslucia.com</strong></a> to flag suspicious activity on your account.</mj-text>
