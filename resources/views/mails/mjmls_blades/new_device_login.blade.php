<mjml>
  ...
  <mj-column>
    ...
    <mj-section background-color="#fff">
      <mj-column>
        <mj-text mj-class="heading">New device login</mj-text>
        <mj-text>Your account was just accessed from a new device, let us know if this was not you please contact <a class="link-nostyle" href="mailto:hello@letslucia.com"><strong>hello@letslucia.com</strong></a>.</mj-text>
