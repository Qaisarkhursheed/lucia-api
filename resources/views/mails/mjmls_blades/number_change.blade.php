<mjml>
  ...
  <mj-column>
    ...
    <mj-section background-color="#fff">
      <mj-column>
        <mj-text mj-class="heading">Phone Number Successfully Changed</mj-text>
        <mj-text>Hi [Name],</mj-text>
        <mj-text>The phone number associated to your account has been changed successfully. If you did this then you do not have to do anything. If you did not do this and there is a security breach please contact <a class="link-nostyle" href="mailto:hello@letslucia.com"><strong>hello@letslucia.com</strong></a>.</mj-text>
