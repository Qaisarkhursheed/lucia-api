                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <div style="font-family:Cormorant, Arial;font-size:34px;font-weight:100;letter-spacing:0;line-height:38px;text-align:center;color:#000000;">Refunded request for  {{ $advisorRequest->user->first_name }}</div>
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <div style="font-family:Montserrat, Arial;font-size:14px;line-height:160%;text-align:center;color:#000000;">Hey Admin,</div>
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <div style="font-family:Montserrat, Arial;font-size:14px;line-height:160%;text-align:center;color:#000000;">There is a request has been refunded:
                                        {{-- {{ $advisorRequest->user->first_name }}: --}}
                                    </div>
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <div style="font-family:Montserrat, monospace;font-size:16px;font-weight:700;line-height:160%;text-align:center;color:#BA886E;">{{ $advisorRequest->request_title }}  with id# {{$advisorRequest->id}}</div>
                            ...
                            {{-- <tr>
                                <td align="center" vertical-align="middle" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <a href="{{ myAssetUrl("/copilot/public/advisor-request/decline?" . http_build_query(["id" => $advisorRequest->id, "token" => \App\Http\Controllers\Copilot\RequestMailResponseController::tagUrlEncrypted($advisorRequest) ])) }}"
                                       style="text-decoration: none; cursor: pointer">
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;width:100%;line-height:100%;">
                                        <tbody>
                                        <tr>
                                            <td align="center" bgcolor="#ffffff" role="presentation" style="border:1px solid #EB5757;border-radius:50px 50px 50px 50px;cursor:auto;mso-padding-alt:20px 20px;background:#ffffff;" valign="middle">
                                                <p style="display:inline-block;background:#ffffff;color:#EB5757;font-family:Montserrat, Arial;font-size:14px;font-weight:700;line-height:120%;letter-spacing:2;margin:0;text-decoration:none;text-transform:none;padding:20px 20px;mso-padding-alt:0px;border-radius:50px 50px 50px 50px;">
                                                    DECLINE REQUEST
                                                </p>
                                            </td>
                                        </tr>
