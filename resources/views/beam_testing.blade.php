            ...
            .then((state) => {
                ...
                switch (state) {
                    case states.PERMISSION_DENIED: {
                        ...
                        console.log("Please, unblock notifications in browser.");
                        window.location.href=getURLParameter('redirect_url');
                        break;
                    }
                    ...
                    case states.PERMISSION_PROMPT_REQUIRED: {
                        ...
                        console.log("Please, allow notifications in browser.");
                        window.location.href= "/beam-prompt?userId=" + getURLParameter("userId")
                            + "&token=" + getURLParameter("token") + "&redirect_url=" + getURLParameter("redirect_url") ;
                        break;
                    }
                }
            })
